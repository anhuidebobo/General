...
namespace General.Mvc.Areas.Admin.Controllers
{
    ...
    public class RoleController : AdminPermissionController
    {
        ...
        [Function("角色列表", true, "menu-icon fa fa-caret-right", FatherResource = "General.Mvc.Areas.Admin.Controllers.SystemManagerController", Sort = 1)]
        ...
        [HttpPost]
        [Route("permission")]
        public JsonResult RolePermission(Guid id, List<Guid> sysResource)
        {
